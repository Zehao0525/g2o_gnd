...
UTSIAMessage UTISASlamSystem::handleObservationSyncRequest(UTSIAMessage& msg) {
  ...
  // TODO OK maybe not this. I recon we turn the kernles flat rather than doing this. But then I'd need a new GGD kernel, will do later
