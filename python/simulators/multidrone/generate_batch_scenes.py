...
Primary use (API, not CLI args):
  from simulators.multidrone.generate_batch_scenes import (
...
try:
    ...
    from simulators.multidrone.core.landmark_generator import landmark_generation
except ModuleNotFoundError:
    # Allow direct execution: python .../generate_batch_scenes.py
    import sys
    from pathlib import Path as _Path

    sys.path.insert(0, str(_Path(__file__).resolve().parent))
    from core.trajectory_generator import trajectory_generation
    from core.landmark_generator import landmark_generation
