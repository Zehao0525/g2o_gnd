...
try:
    ...
    from simulators.multidrone.core.trajectory_generator import trajectory_generation  # noqa: F401
except ModuleNotFoundError:
    # Allow direct execution: python .../batch_simulate_from_scenes.py
    import sys
    from pathlib import Path as _Path

    sys.path.insert(0, str(_Path(__file__).resolve().parent))
    from core.simulator import WorldSim  # type: ignore
    from core.trajectory_generator import trajectory_generation  # noqa: F401  # type: ignore


DEFAULT_CONFIG_PATH = "python/simulators/multidrone/config/sim_config_lm_off.json"
DEFAULT_TRAJ_ROOT = "test_data/multidrone2/scenes/100_0lm_0midpoint_RAL_mod_test"
DEFAULT_BATCH_ROOT = "test_data/multidrone2/RAL_mod/100_0lm_0midpoint_f1_test"
