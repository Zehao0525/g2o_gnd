...
if __name__ == "__main__":
    ...
    try:
        ...
        ctrl = VelocityXZWaypointController.from_json('python/simulators/multidrone/config/sim_config.json', '1', DT)
    except NameError:
    ...
    sim = DroneSim('1', ctrl, world_sim = None, 
                 msg_log_path = 'python/simulators/multidrone/msg_log.txt',
                 gt_log_path = 'python/simulators/multidrone/gt_log.txt',
                 config_path = 'python/simulators/multidrone/config/sim_config.json',
                 dt = DT,
                 yaw0 = 0)
