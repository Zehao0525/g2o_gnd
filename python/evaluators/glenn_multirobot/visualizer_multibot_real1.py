...
if __name__ == "__main__":
    ...
    filename = "test_results/multirobot/fullGraph1.g2o"
    results_gt = read_se3_vertices_as_se2(filename, realign=True)
    print("len(results_gnd)", len(results_gt))

    # Our method
    filename = "test_results/multirobot/file_trajectory_opt_bot1.g2o"
    results_gnd = read_se3_vertices_as_se2(filename, idbound=(4225,9000))
    print("len(results_gnd)", len(results_gnd))

    filename = "test_results/multirobot/multi_round/file_trajectory_opt_bot1.g2o"
    results_gnd_sr = read_se3_vertices_as_se2(filename, idbound=(4225,9000))
    print("len(results_gnd)", len(results_gnd))

    # No communications
    filename = "test_results/multirobot/file_trajectory_pre_comm_bot1.g2o"
    result_before = read_se3_vertices_as_se2(filename, idbound=(4225,9000))
    print("len(result_before)", len(result_before))

    # DPGO
    filename = "test_results/DPGO_results/robot1/trajectory_optimized.csv"
    ...
    # DPGO
    filename = "test_results/multirobot3/multi_round/file_trajectory_opt_bot1.g2o"
    ...
    # DPGO
    #filename = "test_results/multirobot/gauss/file_trajectory_opt_bot1.csv"
    ...
    # GT
    filename = "test_data/test1_new_data/bot1/gt1.tum"
    ...
    #ape_gnd,ape_gnd_aligned = ape_evaluate(tum_gt_bot0, result_gauss_sr, tag = "=== ATE (gauss_sr) ===")
    ...
    ape_gnd_sr,ape_gnd_sr_aligned = ape_evaluate(tum_gt_bot0, results_gnd_sr, tag = "=== ATE (gnd_sr) ===")
    ...
    plot_trajectory(results_gnd_sr, 'cyan', False, 'gnd comms edge', alpha = alpha)
