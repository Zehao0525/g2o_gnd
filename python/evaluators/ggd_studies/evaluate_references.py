...
Run from repo root:
  python3 python/evaluators/gnd_studies/evaluate_references.py
  python3 python/evaluators/gnd_studies/evaluate_references.py \\
      --results test_results/gnd_beta_study/references_robust_kernels
"""
...
DEFAULT_RESULTS_ROOT = Path("test_results/gnd_beta_study/references_robust_kernels")
