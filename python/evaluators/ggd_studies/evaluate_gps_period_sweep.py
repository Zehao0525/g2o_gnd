...
Expects layout:
  test_results/gnd_beta_study/gps_period_sweep/period_{P}/test_{i}/...

Run from repo root:
  python3 python/evaluators/gnd_studies/evaluate_gps_period_sweep.py
"""
...
DEFAULT_SWEEP_ROOT = Path("test_results/gnd_beta_study/gps_period_sweep")
