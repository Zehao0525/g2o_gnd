...
Run from repo root:
  python3 python/evaluators/gnd_studies/make_kernel_comparison_table.py
  python3 python/evaluators/gnd_studies/make_kernel_comparison_table.py --periods 1 2 30
"""
...
DEFAULT_RESULTS_PARENT = Path("test_results/gnd_beta_study")
DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "output" / "references" / "paper_tables"

# Publication row order (matches example table).
KERNEL_ORDER = [
    "gaussian",
    "geman_mcclure",
    "gnd",
