...
if __name__ == "__main__":
    ...
    main(
        ...
        batch_root=Path("test_results/multidrone2/RAL_mod/100_0lm_0midpoint_f2_test_gnd"),
        batch_no_gnd_root=Path("test_results/multidrone2/RAL_mod/100_0lm_0midpoint_f2_test_ngnd"),
    )
