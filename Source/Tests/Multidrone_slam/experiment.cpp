...
int main(int argc, char* argv[]) {
  ...
  try {
    const std::string base_config_path = "Source/Tests/Multidrone_slam/config/experiment_base_config.json";
    ...
    std::string view_config_path = "Source/Tests/Multidrone_slam/config/view_config.json";
