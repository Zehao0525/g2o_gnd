...
class AgentManagerNew {
public:
  AgentManagerNew( const std::string& config_path,
...
/// Perform topology-based communication between drones.
  ...
  MultiDroneSLAMSystemNew* getSlamSystem(size_t index) {
...
protected:
  ...
  std::vector<std::unique_ptr<MultiDroneSLAMSystemNew>> slamSystems_;
  ...
  // Whether broadcasts include per-observation robot sync requests (see MultiDroneSLAMSystemNew).
