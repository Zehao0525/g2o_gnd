...
/**
 * COMP0250 SlamSystem rebased onto ::g2o::SlamSystemBase (slam_system_base_new).
 * Parallel to SlamSystem; does not replace it.
 */
class G2O_TUTORIAL_SLAM2D_API SlamSystemNew
 ...
 public:
  ...
  explicit SlamSystemNew(const std::string& filename);
  ~SlamSystemNew() override;
