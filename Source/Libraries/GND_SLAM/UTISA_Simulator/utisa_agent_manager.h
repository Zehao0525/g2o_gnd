...
class UTISAAgentManager {
 public:
  UTISAAgentManager(const std::string& config_path,
...
public:
  ...
  UTISASlamSystem* getSlamSystem(size_t index) {
...
protected:
  ...
  std::vector<std::unique_ptr<UTISASlamSystem>> slamSystems_;
