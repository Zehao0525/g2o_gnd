...
int main(int argc, char* argv[]) {
  ...
  try {
    const std::string base_config_path = "unit_tests/multirobot/utisa/config/experiment_base_config.json";
    const std::string view_config_path = "unit_tests/multirobot/utisa/config/view_config.json";
    ...
    const std::string output_path = j.value("output_path", std::string("test_results/unit_tests/utisa"));
    const std::string topology_path =
        j.value("topology_path", std::string("unit_tests/multirobot/utisa/config/topology.json"));
