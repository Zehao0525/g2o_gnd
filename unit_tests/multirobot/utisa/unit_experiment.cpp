...
int main(int argc, char* argv[]) {
  ...
  try {
    const std::string experiment_config_path = "unit_tests/multirobot/utisa/config/unit_experiment_config.json";
    const std::string view_config_dir = "unit_tests/multirobot/utisa/config";

    const json cfg = readJsonFile(experiment_config_path);
    const std::string view_config_path =
        cfg.value("view_config_path", std::string("unit_tests/multirobot/utisa/config/view_config.json"));
    ...
    const std::string output_path = cfg.value("output_path", std::string("test_results/unit_tests/utisa/unit_experiment"));
    const std::string topology_path =
        cfg.value("topology_path", std::string("unit_tests/multirobot/utisa/config/topology.json"));
