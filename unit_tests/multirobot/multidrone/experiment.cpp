...
int main(int argc, char* argv[]) {
  ...
  try {
    const std::string base_config_path = "unit_tests/multirobot/multidrone/config/experiment_base_config.json";

    std::string slam_config_path;
    std::string input_path;
    std::string output_path = "test_results/unit_tests/multidrone";
    std::string topology_path = "unit_tests/multirobot/multidrone/config/topology.json";
    ...
    std::string view_config_path = "unit_tests/multirobot/multidrone/config/view_config.json";
    ...
    for (size_t i = 0; i < robotIds.size(); ++i) {
        ...
        std::string bot_view_config = "unit_tests/multirobot/multidrone/config/bot" + robotIds[i] + "_view.json";
