...
if __name__ == "__main__":
    ...
    main(
        ...
        pre_dir=Path("test_results/multidrone/lm_comms_test/lm_only_fc/pre_opt_trajectories/0"),
        post_dir=Path("test_results/multidrone/lm_comms_test/lm_only_fc/trajectories"),
        drone_ids=["0", "1", "2", "3", "4"],
        xy_only=False,
    )
