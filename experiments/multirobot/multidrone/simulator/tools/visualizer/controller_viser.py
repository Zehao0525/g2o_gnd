try:
    from simulators.multidrone.core.controller import *
    from simulators.multidrone.core.simulator import *
except ModuleNotFoundError:
    import sys
    from pathlib import Path

    # Allow direct execution: python .../tools/visualizer/controller_viser.py
...
if __name__ == "__main__":
    ...
    try:
        ...
        ctrl = VelocityXZWaypointController.from_json('experiments/multirobot/multidrone/simulator/config/sim_config.json', '1', DT)
    except NameError:
    ...
    sim = DroneSim('1', ctrl, world_sim = None, 
                 msg_log_path = 'experiments/multirobot/multidrone/simulator/msg_log.txt',
                 gt_log_path = 'experiments/multirobot/multidrone/simulator/gt_log.txt',
                 config_path = 'experiments/multirobot/multidrone/simulator/config/sim_config.json',
                 dt = DT,
                 yaw0 = 0)
