try:
    ...
    # Allow direct execution: python .../tools/visualizer/multi_controller_vizer.py
...
if __name__ == "__main__":
    ...
    trajectory_path = "experiments/multirobot/multidrone/simulator/config/trajectories.json"
