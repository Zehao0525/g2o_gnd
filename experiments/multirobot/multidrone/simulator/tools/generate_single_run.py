...
try:
    ...
    from simulators.multidrone.core.trajectory_generator import *
    from simulators.multidrone.core.simulator import *
except ModuleNotFoundError:
    # Allow direct execution: python .../tools/generate_single_run.py
    import sys

    sys.path.append(str(Path(__file__).resolve().parents[1]))
    from core.controller import *
    from core.trajectory_generator import *
    from core.simulator import *

config_path = "experiments/multirobot/multidrone/simulator/config/sim_config.json"
traj_path = "experiments/multirobot/multidrone/simulator/config/trajectories.json"
