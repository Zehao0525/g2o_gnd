#!/usr/bin/env python3
"""
Visualise `bounded_rv` from core.simulator: histogram vs exact marginal PDF and N(0, σ²).

Run from repo root:
  python -m simulators.multidrone.tools.visualize_bounded_rv

Or directly:
  python experiments/multirobot/multidrone/simulator/tools/visualize_bounded_rv.py
"""
...
try:
    from simulators.multidrone.core.simulator import bounded_rv
except ModuleNotFoundError:
    import sys
    from pathlib import Path

    sys.path.append(str(Path(__file__).resolve().parents[1]))
    from core.simulator import bounded_rv
