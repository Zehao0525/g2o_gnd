...
| `visualizer_multibot_real.py` | Bot0: GT vs GGD / pre-comm / full-graph / DPGO |
...
```bash
python experiments/multirobot/glenn_multirobot/evaluation/visualizer_multibot_real.py
```
