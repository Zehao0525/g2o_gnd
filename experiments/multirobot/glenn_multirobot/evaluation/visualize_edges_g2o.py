...
Run from repo root:
  python3 experiments/multirobot/glenn_multirobot/evaluation/visualize_edges_g2o.py
  python3 experiments/multirobot/glenn_multirobot/evaluation/visualize_edges_g2o.py \
      test_data/glenn_multirobot/test1_new_data/bot1/edges.g2o
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=Path("test_data/glenn_multirobot/test1_new_data/bot1/edges.g2o"),
