...
if __name__ == "__main__":
    ...
    filename = "test_results/glenn_multirobot/multibot_full_graph/full_graph0.g2o"
    ...
    results_ggd = read_se3_vertices_as_se2(filename, idbound=(0,4225))
    print("len(results_ggd)", len(results_ggd))

        # Our method
    filename = "test_results/glenn_multirobot/single_round/file_trajectory_opt_bot0.g2o"
    results_ggd_sr = read_se3_vertices_as_se2(filename, idbound=(0,4225))
    print("len(results_ggd)", len(results_ggd))
    ...
    # DPGO
    filename = "test_results/glenn_multirobot/DPGO_results/robot0/trajectory_optimized.csv"
    ...
    # GT
    filename = "test_data/glenn_multirobot/test1_new_data/bot0/gt0.tum"
    ...
    ggd_sr_opt_pose_path = list_to_pose_path(results_ggd_sr)
    ...
    ape_ggd,ape_ggd_aligned = ape_evaluate(tum_gt_bot0, results_ggd_sr, tag = "=== ATE (ggd_sr) ===")
