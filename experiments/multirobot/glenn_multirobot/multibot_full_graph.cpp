...
// 
// Defaults:
//   Input : test_data/glenn_multirobot/test1_new_data/test1_new_modified.g2o
//   Output: test_results/glenn_multirobot/multibot_full_graph/full_graph.g2o
//
// Build (CMake):
...
int main(int argc, char** argv) {
  std::string input_path  = "test_data/glenn_multirobot/test1_new_data/test1_new_modified.g2o";
  std::string output_path = "test_results/glenn_multirobot/multibot_full_graph/full_graph.g2o";
  int iters = 100;
