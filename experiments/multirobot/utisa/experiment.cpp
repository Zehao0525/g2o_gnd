...
int main(int argc, char* argv[]) {
  ...
  try {
    const std::string base_config_path = "experiments/multirobot/utisa/config/experiment_base_config.json";
    const std::string view_config_path = "experiments/multirobot/utisa/config/view_config.json";
    ...
    const std::string topology_path =
        j.value("topology_path", std::string("experiments/multirobot/utisa/config/topology.json"));
