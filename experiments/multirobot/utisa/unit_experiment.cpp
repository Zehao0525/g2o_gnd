...
int main(int argc, char* argv[]) {
  ...
  try {
    const std::string experiment_config_path = "experiments/multirobot/utisa/config/unit_experiment_config.json";
    const std::string view_config_dir = "experiments/multirobot/utisa/config";

    const json cfg = readJsonFile(experiment_config_path);
    const std::string view_config_path =
        cfg.value("view_config_path", std::string("experiments/multirobot/utisa/config/view_config.json"));
    ...
    const std::string output_path = cfg.value("output_path", std::string("test_results/utisa/unit_experiment"));
    const std::string topology_path =
        cfg.value("topology_path", std::string("experiments/multirobot/utisa/config/topology.json"));
