...
if __name__ == "__main__":
    ...
    choice = 0
    if choice == 0:
        filename = "test_results/comp0250_reimplement/trajectory_est.g2o"
        se2_poses_after = read_se2_vertices(filename)
        

        filename = "test_results/comp0250_reimplement/trajectory_before.g2o"
        se2_poses_before = read_se2_vertices(filename)

        filename = "test_results/comp0250_reimplement/trajectory_gt.g2o"
